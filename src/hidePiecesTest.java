...
public class hidePiecesTest {
    ...
    /**
     *
     * Method: hideBluePieces()
     *
     */
    @Test
    public void testHideBluePieces() throws Exception {
//TODO: Test goes here...
    }

    /**
     *
     * Method: hideRedPieces()
     *
     */
    @Test
    public void testHideRedPieces() throws Exception {
//TODO: Test goes here...
    }
...
/*
try {
   Method method = hidePieces.getClass().getMethod("registerComponent", javax.swing.JComponent.class);
...
/*
try {
   Method method = hidePieces.getClass().getMethod("updateInternalBuffers");
   method.setAccessible(true);
   method.invoke(<Object>, <Parameters>);
} catch(NoSuchMethodException e) {
} catch(IllegalAccessException e) {
...
/*
try {
   Method method = hidePieces.getClass().getMethod("invalidate");
   method.setAccessible(true);
   method.invoke(<Object>, <Parameters>);
} catch(NoSuchMethodException e) {
} catch(IllegalAccessException e) {
