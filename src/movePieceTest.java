...
public class movePieceTest {
    ...
    /**
     *
     * Method: movePieceRed(JButton aPiece, JButton dPiece)
     *
     */
    @Test
...
//        assertEquals("3", b.c1squares[4][2].getText());
    ...
    /**
     *
     * Method: movePieceBlue(JButton aPiece, JButton dPiece)
     *
     */
    @Test
    public void testMovePieceBlue() throws Exception {
//TODO: Test goes here...
    }
...
/*
try {
   Method method = movePiece.getClass().getMethod("registerComponent", javax.swing.JComponent.class);
...
/*
try {
   Method method = movePiece.getClass().getMethod("updateInternalBuffers");
   method.setAccessible(true);
   method.invoke(<Object>, <Parameters>);
} catch(NoSuchMethodException e) {
} catch(IllegalAccessException e) {
...
/*
try {
   Method method = movePiece.getClass().getMethod("invalidate");
   method.setAccessible(true);
   method.invoke(<Object>, <Parameters>);
} catch(NoSuchMethodException e) {
} catch(IllegalAccessException e) {
